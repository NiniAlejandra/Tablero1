...
subtitle: "Actividad 1: Carrera la Luz Tablero Alejandra Valderrama"
output: 
...
```{r}
paleta6=c("#247270", "#6d9493", "#F6E221", "#D6B916", "#F69482", "#BC6C56")
p1=ggplot(CarreraLuz22F, aes(y=timerun/60, x=categoria))+
  geom_jitter(color="#2F9CE3", size=1, alpha=0.9) +
  aes(color=paleta6)+
  labs(title = " ",
       y= "tiempo - min",
       x= "categorías")+ 
